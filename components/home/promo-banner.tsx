...
export default function PromoBanner() {
  return (
    <div className="mx-auto max-w-7xl px-2 pb-0 pt-2 md:pt-10">
      <div className="rounded-xl bg-neutral-900 dark:bg-transparent">
        <div className="relative overflow-hidden rounded-xl border border-neutral-700 bg-gradient-to-br from-blue-900/50 via-blue-800/20 to-yellow-900/30 px-2 py-2 md:px-10 md:py-3">
          ...
          <div className="relative grid grid-cols-1 items-center gap-8 px-6 pb-0 pt-8 md:grid-cols-2 md:px-8 md:py-8">
            {/* ── Left — Text Content ── */}
            <div>
              {/* Headline */}
              <h2
              ...
              <p className="mb-6 max-w-sm font-content text-sm leading-relaxed text-neutral-400">
                This August only - get{' '}
                <span className="font-semibold text-neutral-200">15% off</span> your entire order.
              </p>
            ...
            <div className="relative flex min-h-[270px] items-center justify-center md:min-h-[320px]">
              <Image
                src="/happylady.png"
